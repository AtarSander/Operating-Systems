...
#define USER_IO_Q          2	/* ready users are scheduled via queue 2 */
#define USER_INT_Q         3	/* ready users are scheduled via queue 2 */
#define USER_NUM_Q         4	/* ready users are scheduled via queue 2 */
