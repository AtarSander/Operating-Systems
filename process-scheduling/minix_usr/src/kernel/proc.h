...
#define PPRI_USER_IO	3	/* User process */
#define PPRI_USER_INT	4	/* User process */
#define PPRI_USER_NUM	5	/* User process */
#define PPRI_IDLE	6	/* Idle process */
...
#define isuserp(p)	  ((p)->p_priority >= PPRI_USER_IO && (p)->p_priority <= PPRI_USER_NUM)
#define isuseriop(p)      ((p)->p_priority == PPRI_USER_IO)
#define isuserintp(p)     ((p)->p_priority == PPRI_USER_INT)
#define isusernump(p)     ((p)->p_priority == PPRI_USER_NUM)
